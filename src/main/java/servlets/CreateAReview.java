 ...
 * @author aleks
 */
@WebServlet(name = "CreateAReview", urlPatterns = {"/CreateAReview"})
public class CreateAReview extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CreateAReview</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CreateAReview at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (typeUser.equals("student")) {
            try {
                ...
                response.getWriter().write(ert.reviewToJSON(review));
