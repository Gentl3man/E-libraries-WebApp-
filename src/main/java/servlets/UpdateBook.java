...
public class UpdateBook extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Book book = ebt.jsonToBook(jc.getJSONFromAjax(request.getReader()));
        ...
        try {
            Book exists = ebt.databaseBook_Check_ISBN(book.getIsbn());
            if (exists == null) {
                response.setStatus(403);
            } else {
                ebt.updateBookData(book);
                response.setStatus(200);
                response.getWriter().write(ebt.bookToJSON(book));
            }
        } catch (Exception e) {
