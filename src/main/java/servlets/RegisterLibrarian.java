...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            Librarian lib_exists = lib_table.LibrarianExists(libr.getUsername(), libr.getEmail());
            Student student_exists = eut.DatabaseStudentExists(libr.getUsername(), libr.getEmail());
            if(lib_exists!=null || student_exists!=null){
                ...
                lib_table.addNewLibrarian(libr);
